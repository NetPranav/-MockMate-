...
export default function DashboardLayout({
  ...
  return (
    <div className="min-h-screen flex bg-background">
      {/* ===== Sidebar ===== */}
      <aside className="w-64 border-r border-white/5 flex flex-col fixed h-full z-40 bg-background/80 backdrop-blur-xl">
        {/* Logo */}
        ...
        <div className="p-4 border-t border-white/5">
          <div className="flex items-center gap-3 px-2 mb-3">
            <div className="w-9 h-9 rounded-full gradient-purple-cyan flex items-center justify-center text-white text-sm font-bold">
