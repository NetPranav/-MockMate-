...
export default function InterviewChatPage() {
  ...
  return (
    <div className="flex flex-col h-screen">
      ...
      {/* ===== Top Bar ===== */}
      <div className="h-14 border-b border-white/5 flex items-center justify-between px-6 glass">
        ...
        <div className="flex items-center gap-4">
          ...
          {/* Global Timer */}
          <div className="flex items-center gap-1.5 text-sm text-muted-foreground ml-2 border-l border-white/10 pl-4">
